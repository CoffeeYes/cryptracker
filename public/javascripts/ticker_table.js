var table = {
  ...
  'Kraken' : {
    'tickers' : ["BCHEUR","BCHUSD","BCHXBT","DASHEUR","DASHUSD","DASHXBT","EOSETH","EOSEUR","EOSUSD","EOSXBT","GNOETH","GNOEUR","GNOUSD","GNOXBT","USDTUSD","ETCETH","ETCXBT","ETCEUR","ETCUSD","ETHXBT","ETHCAD",
    "ETHEUR","ETHGBP","ETHJPY","ETHUSD","ICNETH","ICNXBT","LTCXBT","LTCEUR","LTCUSD","MLNETH","MLNXBT","REPETH","REPXBT","REPEUR","REPUSD","XBTCAD","XBTEUR","XBTGBP",
    "XBTJPY","XBTUSD","XDGXBT","XLMXBT","XLMEUR","XLMUSD","XMRXBT","XMREUR","XMRUSD","XRPXBT","XRPCAD","XRPEUR","XRPJPY","XRPUSD","ZECXBT","ZECEUR","ZECJPY","ZECUSD"],
